			...
			<form id="formAssignLocation" class="form">
				...
				<div class="field">
					...
					<select class="form-control" name="inboundLocation" id="inboundLocation">
						<option value="Location_F"
							<c:if test="${inboundDetailData.inboundLocation == 'loc_F'}">selected</c:if>>
							Location_F
						</option>
						<option value="Location_G"
							<c:if test="${inboundDetailData.inboundLocation == 'loc_G'}">selected</c:if>>
							Location_G
						</option>
						<option value="Location_H"
							<c:if test="${inboundDetailData.inboundLocation == 'loc_H'}">selected</c:if>>
							Location_H
						</option>
					</select>
				</div>
