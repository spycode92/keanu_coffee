...
<body>
	...
	<section class="content">
		<header>
			<h1 class="card-title">재고 업데이트</h1>
		</header>
		...
		<form class="card" action="/inventory/updateInventory" method="post">
			<table>
				<tr>
					<td class="form-label">로케이션 ID</td>
					<td>
						<input class="form-control" id="locationIdx" type="text" name="locationIdx" required>
					</td>
				</tr>
				<tr>
					<td class="form-label">Lot ID</td>
					<td>
						<input class="form-control" id="lotNumber" type="text" name="lotNumber" required>
					</td>
				</tr>
				<tr>
					<td class="form-label" >수량조절</td>
					<td>
				...
				<tr>
					<td colspan="2" style="text-align: center;"><br> <input
						class="btn btn-primary" type="submit" value="업데이트"></td>
				</tr>
			</table>
		</form>
