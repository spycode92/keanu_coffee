...
<body>
    ...
    <script>
	    /* ====================== Mock 데이터 ====================== */
	    const realtimeData = [
	        { loc:'A-01', name:'바닐라 시럽', code:'SYR-001', qty:42, unit:'BOX', locType:'Picking', manDate:'2025-02-20', expDate:'2025-09-05', lotNo:'LOT-SYR-001-20250220-01' },
	    ...
	    const inboundByLot = {
	        'LOT-SYR-001-20250220-01': { itemCode:'SYR-001', lotNo:'LOT-SYR-001-20250220-01', mfgDate:'2025-02-20', expDate:'2025-09-05', unit:'BOX', supplier:'케아누식품' },
	    ...
	    function renderTable(opts = {}){
	        ...
	        let data = realtimeData.filter(r=>{
	            ...
	            return ok1 && ok2 && ok3 && okMfgEnd && okExpStart;
	        });
	    ...
	    $(function () {
	        ...
	        $('#threshold, #statusFilter, #sortOption, #mfgEnd, #expStart').on('change', ()=>renderTable());
