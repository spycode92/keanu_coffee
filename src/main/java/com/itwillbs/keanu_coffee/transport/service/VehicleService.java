...
public class VehicleService {
	...
	// 차량관리 페이징
	public int getVehicleCount(String filter) {
		return vehicleMapper.selectVehicleCount(filter);
	}
	
	// 차량 리스트
	public List<VehicleDTO> getVehicleList(int startRow, int listLimit, String filter) {
		return vehicleMapper.selectVehicleList(startRow, listLimit, filter);
	}
